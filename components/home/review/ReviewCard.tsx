...
export default function ReviewCard({ review, name, position, organization }: IProps) {
  return (
    <div className='shadow-xl border border-gray-200 text-center p-8 w-full max-w-[900px] rounded-md m-auto bg-purple-100 dark:bg-purple-800 bg-opacity-50 dark:bg-opacity-15 backdrop-blur-2xl'>
