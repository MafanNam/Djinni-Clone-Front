...
export default function Jumbotron() {
  ...
  return (
    <div className='pb-20 pt-14 px-10 md:px-0 bg-gradient-to-r from-blue-100 to-pink-300'>
      ...
      <br/>
      <p className='text-gray-600 text-sm text-center'>{`<NUM VACANCY>`} jobs listed here! Your dream job is waiting</p>
      <div
        ...
        <form onSubmit={handleSubmit} className='flex md:flex-row flex-col justify-between items-center h-full gap-3'>
          <div
            ...
            <input type='text' value={search} onChange={e => setSearch(e.target.value)}
                   placeholder='Job title or keyword' className='outline-0 h-full px-2 w-full text-sm'/>
          </div>
          <button
